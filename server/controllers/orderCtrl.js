...
module.exports = {
    createOrder: function(req, res) {
        var params = [req.body.order_first_name, req.body.order_last_name, req.body.order_email, req.body.order_phone, req.body.order_address, req.body.order_city, req.body.order_state, req.body.order_zip, req.body.order_country];
        db.orders.create_order(params,
            function(err, result) {
                console.log(err);
                console.log(result);
